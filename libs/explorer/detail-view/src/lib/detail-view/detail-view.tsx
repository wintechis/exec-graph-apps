import { DataSet, getObjectLabel } from '@exec-graph/graph/types';
...
export interface DetailViewProps {
  /**
   * The dataset to extract information about the selected object from
   */
  data: DataSet;
  /**
   * URI of the selected graph object
   */
...
export function DetailView(props: DetailViewProps) {
  ...
  const types = props.data.schema.nodePredicates
