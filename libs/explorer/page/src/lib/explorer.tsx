        ...
        >
          <div className="overflow-y-auto" style={{ height: '70vh' }}>
            ...
            <div className="pl-4 pr-4 pt-2">
              ...
              <div className="w-full inline-flex">
                ...
                <p className="pl-6 w-11/12">
                  <ol className="list-disc">
                    <li>
                      Hover over/click on nodes to reduce graph to subgraph with
                      that node
                    </li>
              ...
              <p className="pt-1">
                The details section displays information about the clicked node
            ...
            <div className="pl-4 pr-4 pt-2">
              ...
              <div className="w-full inline-flex">
                ...
                <p className="pl-6 w-11/12">
                  <ol className="list-disc">
                    <li>
                      On the upper left, you can zoom, center the camera, enter
                      full screen mode and run/stop the Layout Algorithm
                      (ForceAtlas2)
                    </li>
                    <li>
                ...
                <p className="pl-6 w-11/12">
                  ...
                  <ol className="pl-8 pt-1 pb-1 list-decimal">
                    ...
                    <li className="font-bold">
                      Advanced
                      <p className="font-normal">
                        The advanced editor provides a form with autocompletion
                        lists to create a custom SPARQL query. <br />
