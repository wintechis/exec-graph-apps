...
import { DetailView as WrappedDetailView } from '@exec-graph/explorer/detail-view';
import LoadingBar, {
  LoadingStatus,
  Step,
...
export class DetailView extends Component<DetailViewProps, DetailViewState> {
  ...
  /**
   * React event hook called upon change of passed properties
   */
  public override componentDidUpdate(
    prevProps: Readonly<DetailViewProps>
  ): void {
  ...
  /**
   * Show the actual detail view with an additional loading bar
   * @returns page section for the details
   */
